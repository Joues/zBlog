...
public class DateUtils {
     ...
     * @return
     */
    public static List<Object> getOldYearMonths() {
    ...
    public static void main(String[] args) {
        List<Object> oldYearMonths = getOldYearMonths();
        System.out.println(oldYearMonths);
        String yearMonth = (String) oldYearMonths.get(0);
