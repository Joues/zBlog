...
public interface CommonConstant {
    ...
    public static final String TODO_SUCCESS = "操作成功";
    public static final String LOGIN_SUCCESS = "登录成功";
    public static final String TODO_FAILED = "操作失败，请联系管理员！QQ：1987247505";
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:it.ityihang.zblog.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
